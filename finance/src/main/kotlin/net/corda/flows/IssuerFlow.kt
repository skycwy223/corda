...
object IssuerFlow {
    ...
    class IssuanceRequester(val amount: Amount<Currency>, val issueToParty: Party, val issueToPartyRef: OpaqueBytes,
        ...
        override fun call(): AbstractCashFlow.Result {
            ...
            return AbstractCashFlow.Result(stx, TxKeyFlow.TxIdentities(Pair(issueToParty, identity)))
        }
    }
    ...
    class Issuer(val otherParty: Party) : FlowLogic<SignedTransaction>() {
        ...
        override fun call(): SignedTransaction {
            ...
            send(otherParty, Pair(txn.stx, txn.identities.forParty(issueRequest.issueToParty)))
            return txn.stx
        }
        ...
        private fun issueCashTo(amount: Amount<Currency>,
            ...
            val moveCashFlow = CashPaymentFlow(amount, this.otherParty, anonymous = false)
